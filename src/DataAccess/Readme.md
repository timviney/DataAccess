...
COPY . .
RUN dotnet build "DataAccess.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "DataAccess.csproj" \
...
Execute unit tests
```
cd "DataAccess/test/DataAccess.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "DataAccess/src/DataAccess"
